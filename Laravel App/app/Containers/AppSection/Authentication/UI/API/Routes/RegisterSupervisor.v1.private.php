...
use App\Containers\AppSection\Authentication\UI\API\Controllers\RegisterSupervisorController;
use Illuminate\Support\Facades\Route;

Route::post('/register/supervisor', RegisterSupervisorController::class)->middleware(['auth:api','role:'.config('appSection-authorization.admin_role')]);
